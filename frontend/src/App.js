...
function App() {
  ...
  const handleAddToCart = (item) => {
    ...
    // The previous code block here was simulating an error for 'Golden Latte'.
    // The backend menu data shows 'Golden Latte' *does* have a price, so this simulation is misleading.
    // Removing the simulated error to allow 'Golden Latte' to be added to the cart normally.
