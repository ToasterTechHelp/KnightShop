...
function App() {
  ...
  const handleAddToCart = (item) => {
    ...
    // Bug: Golden Latte causes an error when adding to cart - This block simulates an error.
    // Removing this block to fix the issue where Golden Latte cannot be added to cart.
