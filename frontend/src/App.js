...
function App() {
  ...
  const handleAddToCart = (item) => {
    ...
    // Bug: Golden Latte causes an error when adding to cart - REMOVED
    // The original code deliberately caused an error for Golden Latte.
    // Removing this block allows Golden Latte to be added to the cart normally.
